...
//                paging(page, 3);
    ...
    private NhanVien getFormData(){
        ...
        return new NhanVien(WIDTH, manv, tennv, ns, gioiTinh, diaChi, sdt, email);
    }
    public void reset(){
        txtMa.setText("");
        txtTen.setText("");
    ...
    private void initComponents() {
        ...
        tblNhanVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "STT", "Mã NV", "Họ tên", "Ngày sinh", "Giới tính", "SDT", "Địa chỉ", "Email"
            }
        ) {
...
//        showData(service.search(timkiem));
